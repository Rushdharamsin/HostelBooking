<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="HostelBooking.userprofile" %>
    ...
    <div class="container-fluid">
      <div class="row">
         <div class="col-md-5">
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBox10" runat="server" placeholder="Email ID" TextMode="Password"></asp:TextBox><br />
                        </div>
                     </div>
                  </div>
                  <div class="row">
            ...
            <a href="homepage.aspx"><< Back to Home</a><br><br><br /><br /><br />
         </div>
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
